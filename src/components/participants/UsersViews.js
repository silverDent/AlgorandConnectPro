...
export const InformPaymentCount = ({paymentCount}) => {
    return (
        <Container className="mt-4">
            <Alert color="primary">
                user is paying {paymentCount } . payment
            </Alert>
        </Container>
    );
}
...
export const userBalanceBeforePayment = ({ getuserBalanceBeforePayment, cardInfoTitle, cardInfoText, cardInfoButton }) => {
    ...
    const handleBalanceBeforePayment = async () => {
        ...
        alert("user is paying " + (regularPaymentCount) + " . payment\n" );

        setTimeout(function (){
            getuserBalanceBeforePayment(balanceVal);
        }, 2000); // How long do you want the delay to be (in milliseconds)?
...
export const userBalanceAfterPayment = ({ getuserBalanceAfterPayment, cardInfoTitle, cardInfoText, cardInfoButton }) => {
    ...
    const handleBalanceAfterPayment = async () => {
        ...
        setTimeout(function (){
            ...
            getuserBalanceAfterPayment(balanceVal);
        }, 2000); // How long do you want the delay to be (in milliseconds)? 
    }
...
export const userLastBalanceScreen = ({ getuserLastBalance, cardInfoTitle, cardInfoText, cardInfoButton }) => {
...
export const CompanyLastBalanceScreen = ({ getCompanyBalance, cardInfoTitle, cardInfoText, cardInfoButton }) => {
        ...
        <Container className="h-100">
            <div className="mt-3">
                <Row>
                    ...
                    <Card className="p-3">
                        <Form.Group>
                            <Form.Label> Do you want to request any money from company company? </Form.Label>
                                <Form.Control
                                    value={payment}
                                    onChange={(e) => setPayment(e.target.value)}
                                    type="number"
                        ...
                        <Button variant="primary" onClick={()=>handleUserRequest()}> Request Money from company Company</Button>
                        </Card>
