...
export async function Company(ctc, interact) {
  ...
  ;
  const v128 = stdlib.protect(ctc0, await interact.getCompanyBalance(), {
...
export async function user(ctc, interact) {
  ...
  while ((() => {
    ...
    const v58 = stdlib.protect(ctc0, await interact.getuserBalanceBeforePayment(), {
      ...
      msg: 'getuserBalanceBeforePayment',
      who: 'user'
      });
    ...
    const v99 = stdlib.protect(ctc0, await interact.getuserBalanceAfterPayment(), {
      ...
      msg: 'getuserBalanceAfterPayment',
      who: 'user'
      });
  ...
  const v114 = stdlib.protect(ctc0, await interact.getuserLastBalance(), {
